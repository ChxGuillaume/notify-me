...
module.exports = class DiscordSnowgiving {
    ...
    constructor(client) {
        ...
        cron.schedule('*/5 * * * *', () => {
            this.fetch('https://discordmerch.com/products/snowsgiving-full-zip-bundle?variant=39637669740643');
        }, {});
        this.fetch('https://discordmerch.com/products/snowsgiving-full-zip-bundle?variant=39637669740643');
    }
    ...
    channel() {
        return this.client
            ...
            .channels.cache.find(channel => channel.id === '917573295421915186')
    }
        ...
        axios
            ...
            .then(async (response) => {
                ...
                const {
                    images: {0: image},
                    variants,
                } = JSON.parse($articlePage('script').toArray().find(e => $articlePage(e).attr('id') === 'ProductJson-product-template').children[0].data);
