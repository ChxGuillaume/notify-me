...
module.exports = class Keychron {
    constructor(client) {
        ...
        cron.schedule(
            ...
            () => {
                this.fetch(
                    'https://www.keychron.com/products/keychron-k5-ultra-slim-wireless-mechanical-keyboard?variant=39559179108441'
                )
                this.fetch(
                    'https://www.keychron.com/products/low-profile-keychron-optical-switch-set-87-pcs?variant=32264204615769'
                )
                this.fetch(
                    'https://www.keychron.com/products/keychron-custom-coiled-cable?variant=39408315826265'
                )
            },
            {}
        )
    ...
    save() {
        fs.writeFileSync(
            ...
            JSON.stringify(this.keyboard_vailable)
        )
    }
    ...
    channel() {
        return this.client.guilds.cache
            ...
            .channels.cache.find(
                (channel) => channel.id === '915648102340366398'
            )
    }
    ...
    fetch(url) {
        axios.get(url).then(async (response) => {
            ...
            const {
                ...
                $keyboardPage('[aria-label="Variant JSON"]').text().trim()
            )
